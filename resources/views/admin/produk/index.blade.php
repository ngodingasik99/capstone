                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/produk/{{$item->id}}"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="/produk/{{$item->id}}" method="post" enctype="multipart/form-data">
                ...
                <input type="text" class="form-control @error ('product_name') is-invalid @enderror" id="product_name" name="product_name" value="{{$item->product_name}}">
                @error('product_name')
                ...
                <input type="text" class="form-control @error ('stock') is-invalid @enderror" id="stock" name="stock" value="{{$item->stock}}">
                @error('stock')
